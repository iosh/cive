...
A Public Client is interface to the [Conflux Core Space JSON-RPC](https://doc.confluxnetwork.org/docs/core/build/json-rpc/). See the all supported [Public Actions](#TODO) for more details.
