...
test('error: constructor not found', () => {
  ...
  ).toThrowError(`A constructor was not found on the ABI.
...
test('error: no inputs', () => {
  ...
  ).toThrowError(`Constructor arguments were provided (\`args\`), but a constructor parameters (\`inputs\`) were not found on the ABI.
